            ...
            <div className="flex flex-wrap gap-2">
              {categories.map(cat => (
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-[10px] uppercase tracking-widest font-black transition-all ${filter === cat
                    ? "bg-white text-black"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredActivities.length > 0 ? filteredActivities.map((activity, idx) => (
              ...
              >
                ...
                <button className="w-full flex items-center justify-between gap-3 text-[10px] font-black uppercase tracking-[0.2em] group-hover:translate-x-5 transition-all text-white/60 hover:text-white">
