  ...
  return (
    <section id="stays" className="py-24 bg-white text-black overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="mb-12 text-center lg-left">
          {selectedState && (
        ...
        <div className="grid grid-cols-1 lg-cols-2 gap-20">
          <div className="mb-12">
            <h2 className="text-sm font-bold uppercase tracking-[0.4em] text-black/40 mb-4">Base Camps</h2>
            <h3 className="text-4xl md-5xl font-black tracking-tight mb-6">AFFORDABLE <br />SANCTUARIES</h3>
          ...
          <div className="space-y-4">
            {STAYS.length > 0 ? STAYS.map((stay, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center justify-between p-6 rounded-2xl border border-black/5 hover-zinc-50 transition-colors cursor-pointer group"
              >
        ...
        <div id="food">
          <div className="mb-12">
            ...
            <h3 className="text-4xl md-5xl font-black tracking-tight mb-6">LOCAL <br />PROVISIONS</h3>
            <p className="text-black/60 font-light max-w-md">
          ...
          <div className="space-y-4">
            {FOODS.length > 0 ? FOODS.map((food, idx) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center text-black group-hover-black group-hover-white transition-colors">
