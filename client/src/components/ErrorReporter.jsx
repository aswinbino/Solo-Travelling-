        ...
        <div className="space-y-2">
          {process.env.NODE_ENV === "development" && (
            <details className="mt-4 text-left">
              ...
              <pre className="mt-2 text-xs bg-zinc-100 p-2 rounded overflow-auto text-black">
                {error.message}
                {error.stack && (
          ...
          <button
            onClick={() => reset?.()}
            className="w-full px-4 py-2 bg-black text-white rounded-lg hover:bg-zinc-800 transition-colors"
          >
            Try again
          </button>
        </div>
